...
def p05mt3d(exe_name_mf, exe_name_mt, model_ws, mixelm, dt0, ttsmult):
...
def test_mt3dmsp05a():  
    ...
    mf, mt, conc_mt3dusgs, cvt, mvt = p05mt3d(exe_name_mf, exe_name_mt3dusgs,
                                              mt3dusgs_ws, mixelm, dt0, ttsmult)
