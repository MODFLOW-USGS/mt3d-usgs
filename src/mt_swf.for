C
C THIS FILE CONTAINS SUBROUTINES THAT ARE COMMON TO SURFACE-WATER-FLOW COMPONENTS
C
      SUBROUTINE SWF5FM(ICOMP)
      USE SFRVARS
      USE XMDMODULE
...
C
C.....SFR PACKAGE
      IF(iUnitTRNOP(19).GT.0) CALL SFT5FM(ICOMP)
C
C.....SWR PACKAGE
...
C
C.....SFR PACKAGE
      IF(iUnitTRNOP(19).GT.0) CALL SFT5FMGW(ICOMP)
C
C.....SWR PACKAGE
