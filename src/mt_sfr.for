...
C--WRITE SFR MASS BALANCE TO OUTPUT FILE
      IF(PRTOUT) THEN
        ...
        IF(INLKT.GT.0) WRITE(IOUT,45) CLAK2SFR(ICOMP),LAK2SFR
        ...
        IF(INLKT.GT.0) WRITE(IOUT,85) CLAKFROMSFR(ICOMP),LAKFROMSFR
