...
C***********************************************************************
     ...
     &                         DTRANS,NLAY,NROW,NCOL,ICBUND,NODES
      ...
      INTEGER ICOMP
      REAL    DELT,DELTMIN
      INTEGER K,I,J,II,JJ,N,NN,IS,IR,NC,ICNT,ISIN,IRIN
      REAL    CONC,Q,VOL
...
C***********************************************************************
      USE MT3DMS_MODULE, ONLY: INSFT,IOUT,NCOMP,CNEW,TIME2,
     &                         NLAY,NROW,NCOL,ICBUND,NODES,
     &                         PRTOUT,MIXELM,RMASIO
      USE LAKVARS
      USE SFRVARS
      IMPLICIT  NONE
      INTEGER IS,IR
      INTEGER K,I,J,N,NUM,II
      INTEGER ICOMP,KPER,KSTP,NTRANS
