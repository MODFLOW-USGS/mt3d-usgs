...
C
     ...
     &          JTRACK,ITRACK,KTRACK,IVER,ISS,NCOMP,INDEX,NOCREWET
...
C
     ...
     & IRCH,RECH,IEVT,EVTR,MXSS,NSS,NTSS,SS,BUFF,DTSSM,CNEW,SSMC)
C **********************************************************************
...
C
     ...
     &          JJ,II,KK,JM1,JP1,IM1,IP1,KM1,KP1,NCOMP,INDEX
      ...
      REAL      CNEW(NCOL,NROW,NLAY,NCOMP),SSMC(NCOMP,MXSS)
     ...
     &          EVTR(NCOL,NROW),SS(8,MXSS),BUFF(NCOL,NROW,NLAY)
...
!     1  QPRECSFO(NSTRM),QRUNOFSFO(NSTRM),
     ...
     1  INFLWNOD(NSTRM)) !,QOUTSFO(NSTRM))
