...
!
    MODULE PKG2PKG
      ...
      SUBROUTINE MEMDEALLOCATE_PKG2PKG()
        IF(ASSOCIATED(NSFR2LAK))       DEALLOCATE(NSFR2LAK)
        IF(ASSOCIATED(NSFR2UZF))       DEALLOCATE(NSFR2UZF)
        IF(ASSOCIATED(NLAK2UZF))       DEALLOCATE(NLAK2UZF)
        IF(ASSOCIATED(NSNK2UZF))       DEALLOCATE(NSNK2UZF)
