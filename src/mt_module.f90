...
CONTAINS
      ...
      IF(ASSOCIATED(DCDT_SYLD)) DEALLOCATE(DCDT_SYLD)           !# LINE 1932 RCT
      IF(ASSOCIATED(DEA_ED_DT)) DEALLOCATE(DEA_ED_DT)     !# LINE 1933 RCT
      IF(ASSOCIATED(DCDT)) DEALLOCATE(DCDT)               !# LINE 1934 RCT
      IF(ASSOCIATED(DCDTYLD)) DEALLOCATE(DCDTYLD)               !# LINE 1934 RCT
...
!        REAL,             SAVE, DIMENSION(:,:,:,:),   POINTER :: CSURFLK   
...
!        REAL,             SAVE, DIMENSION(:),         POINTER :: CUZT2LAK
