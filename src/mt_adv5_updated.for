...
1054  FORMAT(1X,'STORAGE FORMULATION OPTION = ',I2,
     1      /1X,'= 0 MEANS ORIGINAL MT3D FORMULATION',
     1      /1X,'= 1 MEANS ORIGINAL MT3D FORMULATION WITH',
     1               ' TIME-INTERPOLATED MASS CALCULATION',
     1      /1X,'= 2 MEANS CORRECTED FORMULATION WITH ADSORPTION',
     1      /1X,'= 3 MEANS CORRECTED FORMULATION WITHOUT ADSORPTION')
